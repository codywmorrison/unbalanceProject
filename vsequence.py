...
##----------------PHASE TO LINE VOLTAGE CALCULATION-------------------
...
##k = 0
##
##VlnT = np.transpose(Vln)
##
##print(VlnT[1][0] * (np.cos(0+phData[1][0]) + np.sin(0+phData[1][0])*1j) - VlnT[i][1] * (np.cos(120+phData[1][1]) + np.sin(120+phData[1][1])*1j))
##for i in range(len(phData)):
##
##    Vll[i][0] = VlnT[i][0] * (np.cos(phData[i][0]) + np.sin(phData[i][0]) * 1j) - VlnT[i][1] * (np.cos(2.094+phData[i][1]) + np.sin(2.094+phData[i][1]) * 1j)
##    Vll[i][1] = VlnT[i][1] * (np.cos(2.094+phData[i][1]) + np.sin(2.094+phData[i][1]) * 1j) - VlnT[i][2] * (np.cos(phData[i][2]-2.094) + np.sin(phData[i][2]-2.094) * 1j)
##    Vll[i][2] = VlnT[i][2] * (np.cos(phData[i][2]-2.094) + np.sin(phData[i][2]-2.094) * 1j) - VlnT[i][0] * (np.cos(phData[i][0]) + np.sin(phData[i][0]) * 1j)
##
##    Vab[i] = abs(Vll[i][0])
##    Vbc[i] = abs(Vll[i][1])
##    Vac[i] = abs(Vll[i][2])
